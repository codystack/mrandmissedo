  ...
  <nav id="mainNav" class="navbar navbar-expand-lg navbar-sticky navbar-light bg-light border-bottom">
    <div class="container">
      ...
      <ul class="navbar-nav navbar-nav-secondary order-lg-3">
        <li class="nav-item">
          <a class="nav-link nav-icon" data-bs-toggle="offcanvas" href="account.html#offcanvasCart" role="button"
        ...
        <li class="nav-item dropdown dropdown-hover d-none d-lg-block">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="dropdown-item text-red" href="account.html#">Log Out</a></li>
          </ul>
        </li>
        <li class="nav-item d-lg-none">
      ...
      <div class="collapse navbar-collapse" id="navbar" data-bs-parent="#mainNav">
        <ul class="navbar-nav">
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="account.html#" id="navbarDropdown-1" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              Landings
            </a>
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="account.html#" id="navbarDropdown-2" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              Pages
            </a>
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="account.html#" id="navbarDropdown-3" role="button" data-bs-toggle="dropdown"
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="account.html#" id="navbarDropdown-4" role="button" data-bs-toggle="dropdown"
              aria-expanded="false" data-bs-auto-close="outside">
              Shop
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown-4">
              ...
              <li class="dropend dropend-hover">
                <a class="dropdown-item dropdown-toggle  "
                  href="account.html#" id="navbarDropend-1" data-bs-toggle="dropdown" aria-expanded="false"
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="account.html#" id="navbarDropdown-5" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              Docs
            </a>
      ...
      <div class="collapse account-collapse" id="userNav" data-bs-parent="#mainNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="account.html#">Dashboard</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="account.html#">Settings</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="account.html#">Orders</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="account.html#">Billing</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-red" href="account.html#">Log Out</a>
          </li>
        </ul>
      </div>
        ...
        <div class="row justify-content-between">
          ...
          <aside class="col-lg-3 split-sidebar">
            <nav class="sticky-top d-none d-lg-block">
              <ul class="nav nav-minimal flex-column" id="toc-nav">
                <li class="nav-item">
                  <a class="nav-link fs-lg active" href="account.html">Dashboard</a>
                </li>
                <li class="nav-item">
          ...
          <div class="col-lg-9 split-content">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-xl-8">
                          <p class="text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                            Praesentium nostrum, perferendis
                            animi nulla cupiditate necessitatibus tempore, repellendus quo facilis</p>
                        </div>
                      </div>
                      <div class="row g-1 align-items-center mt-6">
                        <div class="col-auto">
                          <a href="" class="btn btn-white rounded-pill">Complete Profile</a>
                        </div>
                        <div class="col-auto">
            ...
            <section>
              <div class="row">
                <div class="col">
                  <h3 class="fs-4">Numbers</h3>
                  <div class="card bg-opaque-white">
                    <div class="card-body bg-white">
                      <div class="row g-3 g-xl-5">
                        <div class="col-md-6">
                          <span class="eyebrow text-muted">Total Balance</span>
                          <span class="fs-2 text-primary fw-bold d-block">$1300.45</span>
                        </div>
                        <div class="col-md-6">
                          <span class="eyebrow text-muted">Lifetime Earnings</span>
                          <span class="fs-2 text-primary fw-bold d-block">$5600</span>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="accordion-item">
                          <div class="accordion-header" id="heading-1-1">
                            <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse"
                              ...
                              <div class="row g-1 g-xl-5 align-items-center">
                                ...
                                <div class="col-6 col-md-3"><span class="badge bg-primary">On the way</span>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div id="collapse-1-1" class="accordion-collapse collapse" aria-labelledby="heading-1-1"
                            ...
                            <div class="accordion-body">
                              <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore
                                perspiciatis nisi
                                voluptatem. Perspiciatis iure expedita voluptas, dolorem nisi repudiandae amet
                                recusandae quidem explicabo nihil, impedit ab iusto laudantium tempora architecto.</p>
                            </div>
                          </div>
                        </div>
                        <div class="accordion-item">
