...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbar" data-bs-parent="#mainNav">
        <ul class="navbar-nav">
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="contact.html#" id="navbarDropdown-1" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              Landings
            </a>
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="contact.html#" id="navbarDropdown-3" role="button" data-bs-toggle="dropdown"
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="contact.html#" id="navbarDropdown-4" role="button" data-bs-toggle="dropdown"
              aria-expanded="false" data-bs-auto-close="outside">
              Shop
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown-4">
              ...
              <li class="dropend dropend-hover">
                <a class="dropdown-item dropdown-toggle  "
                  href="contact.html#" id="navbarDropend-1" data-bs-toggle="dropdown" aria-expanded="false"
          ...
          <li class="nav-item dropdown dropdown-hover">
            <a class="nav-link dropdown-toggle" href="contact.html#" id="navbarDropdown-5" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              Docs
            </a>
  ...
  <!-- footer -->
  <footer class="py-20 bg-black inverted">
    <div class="container">
